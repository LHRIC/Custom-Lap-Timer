...
#define MINMEA_MAX_SENTENCE_LENGTH 200
#endif
    ...
    // provide backwards compatibility to users expecting a null-terminated
    // string instead of a struct
    union minmea_type
    {
        char buf[6];
        struct
     ...
     */
    bool minmea_parse_gbs(struct minmea_sentence_gbs *frame,
                          const char *sentence);
